...
public class Millionare {
    public static void main(String[] args) {
        System.out.println(calcMillionaire(6000, 0.5));
        calcMillionaireUnitTest();
        

    }

    public static double calcMillionaire(double annualDeposit, double intRate) {
         double total = 0;
        int t = 0;
        ...
        while (total < 1000000) {
            ...
            total = annualDeposit + total;
            total = total + (total*intRate);
            t++;
        }
        return t;
